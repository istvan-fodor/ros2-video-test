...
from .gauge_detection.detection_inference import detection_gauge_face, load_detection_model
...
class ImageProcessor:
    ...
    def process_image(self, image, run_path, debug, eval_mode, image_is_raw=False):
        ...
        box, all_boxes = detection_gauge_face(image)
        ...
        bounding_box_image = plotter.image
